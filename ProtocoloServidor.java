...
public class ProtocoloServidor {
    ...
    public ProtocoloServidor() {
        ...
        tablaPaquetes.put("user7|package7", EstadoPaquete.DESCONOCIDO);
        ...
        tablaPaquetes.put("user14|package14", EstadoPaquete.DESCONOCIDO);
        ...
        tablaPaquetes.put("user21|package21", EstadoPaquete.DESCONOCIDO);
        ...
        tablaPaquetes.put("user28|package28", EstadoPaquete.DESCONOCIDO);
